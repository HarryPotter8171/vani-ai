...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        micro: ['11px', { lineHeight: '1.35', letterSpacing: '-0.006em' }],
        caption: ['12px', { lineHeight: '1.4', letterSpacing: '-0.008em' }],
        xs: ['12px', { lineHeight: '1.4', letterSpacing: '-0.008em' }],
        sm: ['13px', { lineHeight: '1.45', letterSpacing: '-0.01em' }],
        ...
        base: ['15px', { lineHeight: '1.55', letterSpacing: '-0.014em' }],
        chat: ['15.5px', { lineHeight: '1.6', letterSpacing: '-0.014em' }],
        assistant: ['16px', { lineHeight: '1.65', letterSpacing: '-0.014em' }],
        title: ['17px', { lineHeight: '1.3', letterSpacing: '-0.022em' }],
        lg: ['20px', { lineHeight: '1.3', letterSpacing: '-0.022em' }],
